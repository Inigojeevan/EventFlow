...
const NavMenu = () => {
  ...
  return (
    <div className="w-full h-10 bg-transparent border-none flex flex-row gap-2">
      <div className="w-28 h-10 rounded-xl hover:bg-violet-700 shadow-sm hover:shadow-fuchsia-500 bg-violet-900 border-fuchsia-600 border-2 text-white text-base flex justify-center items-center">
