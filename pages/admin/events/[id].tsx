        ...
        <DashboardLayout>
          <div className="border-fuchsia-600 border-4 rounded-xl h-full w-full shadow-md shadow-fuchsia-600">
            <div className="bg-black bg-opacity-55 w-full h-full rounded-xl shadow-md shadow-fuchsia-600">
              <DashEvent Id={event.Id} Title={event.Title} Genre={event.Genre} Image={event.Image} Description={event.Description} Host={event.Host} Event_Date={event.Event_Date} Event_Time={event.Event_Time} Ticket_Price={event.Ticket_Price} Tickets_Sold={event.Tickets_Sold} Attendees={event.Attendees} />
            </div>
          </div>
        </DashboardLayout>
      </div>
